...
public class ShapeAWithTextureBModel implements BakedModel {

    private final BakedModel shapeModel;        // A：形状
    private final BakedModel textureModel;      // B：纹理
    private final BlockState textureState;      // ★ B 模型对应的 state，用于查询 B

    public ShapeAWithTextureBModel(BakedModel shapeModel, BakedModel textureModel,
