package com.renyigesai.bakeries.client.model;// Made with Blockbench 5.1.3
...
public class GlassBreadRackDoorModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("bakeries", "glass_bread_rack_door"), "main");
