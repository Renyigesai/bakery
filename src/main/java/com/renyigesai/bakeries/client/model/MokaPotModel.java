package com.renyigesai.bakeries.client.model;// Made with Blockbench 5.0.7
...
public class MokaPotModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation MOKA_POT = new ModelLayerLocation(new ResourceLocation(BakeriesMod.MODID, "moka_pot"), "main");
	...
	@Override
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float v, float v1, float v2, float v3) {
