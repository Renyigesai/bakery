package com.renyigesai.bakeries.client.model;// Made with Blockbench 5.0.6
...
public class OvenModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation OVEN = new ModelLayerLocation(new ResourceLocation(BakeriesMod.MODID, "oven"), "main");
