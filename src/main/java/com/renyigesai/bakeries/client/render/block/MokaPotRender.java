...
import com.renyigesai.bakeries.client.model.MokaPotModel;
...
public class MokaPotRender implements BlockEntityRenderer<MokaPotBlockEntity> {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation("bakeries","textures/entity/moka_pot.png");

    public MokaPotRender(BlockEntityRendererProvider.Context context) {
        model = new MokaPotModel<>(context.bakeLayer(MokaPotModel.MOKA_POT));
    }
    ...
    public void render(MokaPotBlockEntity entity, float pPartialTick, PoseStack poseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
        ...
        this.model.renderToBuffer(poseStack, vertexConsumer, pPackedLight, pPackedOverlay,1,1,1,1);
        poseStack.popPose();
    }
}
