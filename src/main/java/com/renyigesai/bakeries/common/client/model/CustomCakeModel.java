...
public class CustomCakeModel implements BakedModel {
    ...
    private final ItemOverrides itemOverrides = new ItemOverrides() {
        ...
        public BakedModel resolve(BakedModel model, ItemStack stack, @Nullable ClientLevel level, @Nullable LivingEntity entity, int seed) {
            if (stack.has(BakeriesDataComponents.CUSTOM_CAKE_PART_ID)) {
    ...
    public static class CompositeCakeModel implements BakedModel{
        ...
        public CompositeCakeModel(BakedModel model, List<String> partIds) {
            ...
            for (String partId : partIds) {
                ResourceLocation resourceLocation = ResourceLocation.parse(partId);
                ResourceLocation modelId = ResourceLocation.fromNamespaceAndPath(resourceLocation.getNamespace(), "cake_part/" + resourceLocation.getPath());// bakeries:cake_part/cake_base
                BakedModel partModel = Minecraft.getInstance().getModelManager().getModel(ModelResourceLocation.standalone(modelId));
