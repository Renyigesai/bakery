package com.renyigesai.bakeries.common.client.model;// Made with Blockbench 5.1.1
...
public class FermentationBoxModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation FERMENTATION_BOX = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BakeriesMod.MODID, "fermentation_box"), "main");
