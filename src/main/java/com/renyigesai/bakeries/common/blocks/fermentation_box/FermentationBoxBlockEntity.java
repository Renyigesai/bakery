...
public class FermentationBoxBlockEntity extends BaseContainerBlockEntity {
    ...
    protected void loadAdditional(CompoundTag tag, HolderLookup.Provider registries) {
        ...
        perfectTime = tag.getInt("PerfectTime");
        int[] $$2;
        if (tag.contains("FermentationTime", 11)) {
            $$2 = tag.getIntArray("FermentationTime");
            System.arraycopy($$2, 0, fermentationTime, 0, Math.min(fermentationTime.length, $$2.length));
        }
        fermentationMaxTime = tag.getInt("FermentationMaxTime");
    }
    ...
    public ItemStackHandler getHandlerItems(){
        return items;
    }

    @Override
    protected AbstractContainerMenu createMenu(int containerId, Inventory inventory) {
        return new FermentationBoxMenu(containerId,inventory,this);
    }
    ...
    public static void onOpenMenu(FermentationBoxBlockEntity blockEntity,Player player,BlockPos pos){
    ...
    public static void onCloseMenu(FermentationBoxBlockEntity blockEntity){
