...
public class BrownSugarRoll extends BreadBlock {
//    @Override
...
//
//        if (value == 1) {
//            shapes.add(rotateBox(5.5d,0,5.5d,5,3.5d,5, facing));
//        } else if (value == 2) {
//            shapes.add(rotateBox(2.5d,0,4.5d,11,3.5d,7, facing));
//        } else if (value == 3) {
//            shapes.add(rotateBox(2.5d,0,1.5d,11,3.5d,13, facing));
//        } else if (value == 4) {
//            shapes.add(rotateBox(2.5d,0,2.5d,11,3.5d,12, facing));
//        }
//        return shapes;
//    }
}
