...
//                .effect(()-> new MobEffectInstance(BakeriesMobEffects.ENJOY.get(), 600, 0), 1.0F)
                .build();
...
//                .effect(() -> new MobEffectInstance(BakeriesMobEffects.CHEESE_POWER.get(),600,0),1f)
                .alwaysEdible()
                .build();
...
//                .effect(()->new MobEffectInstance(BakeriesMobEffects.ENJOY.get(),6000),1F)
                .build();
...
//                .effect(()->new MobEffectInstance(BakeriesMobEffects.SOFT.get(),1200),1f)
                .alwaysEdible().build();
...
//                .effect(()->new MobEffectInstance(BakeriesMobEffects.CHEESE_POWER.get(),1200),1f)
                .build();
