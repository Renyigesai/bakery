package com.renyigesai.bakeries.common.inventory.dough_crafting_table;
...
public class DoughCraftingTableMenu extends AbstractContainerMenu {
    ...
    private List<RecipeHolder<DoughCraftingRecipe>> recipes;
    ...
    public DoughCraftingTableMenu(int containerId ,Inventory playerInventory, final FriendlyByteBuf data) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public DoughCraftingTableMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
        super(BakeriesMenuType.DOUGH_MENU.get(), containerId);
    ...
    public List<RecipeHolder<DoughCraftingRecipe>> getRecipes() {
        return this.recipes;
    }
    ...
    private void setupRecipeList(Container container, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.recipes = this.level.getRecipeManager().getRecipesFor(BakeriesRecipeTypes.DOUGH_CRAFTING_TYPE.get(), createRecipeInput(container), this.level);
        }
    ...
    void setupResultSlot() {
        if (!this.recipes.isEmpty() && this.isValidRecipeIndex(this.selectedRecipeIndex.get())) {
            RecipeHolder<DoughCraftingRecipe> recipeholder = (RecipeHolder)this.recipes.get(this.selectedRecipeIndex.get());
            ItemStack itemstack = ((DoughCraftingRecipe)recipeholder.value()).assemble(createRecipeInput(this.container), this.level.registryAccess());
    ...
    public MenuType<?> getType() {
        return BakeriesMenuType.DOUGH_MENU.get();
    }
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (this.level.getRecipeManager().getRecipeFor(BakeriesRecipeTypes.DOUGH_CRAFTING_TYPE.get(), new SingleRecipeInput(itemstack1), this.level).isPresent()) {
