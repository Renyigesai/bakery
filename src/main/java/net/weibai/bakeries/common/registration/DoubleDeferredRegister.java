...
public class DoubleDeferredRegister<PRIMARY, SECONDARY> {
    ...
    private final net.neoforged.neoforge.registries.DeferredRegister<PRIMARY> primaryRegister;
    private final net.neoforged.neoforge.registries.DeferredRegister<SECONDARY> secondaryRegister;

    public DoubleDeferredRegister(net.neoforged.neoforge.registries.DeferredRegister<PRIMARY> primaryRegistry, net.neoforged.neoforge.registries.DeferredRegister<SECONDARY> secondaryRegistry) {
    ...
    protected DoubleDeferredRegister(String modid, ResourceKey<? extends Registry<PRIMARY>> primaryRegistryName,
        ...
        this(modid, primaryRegistryName, BDeferredRegister.create(secondaryRegistryName, modid));
    }

    protected DoubleDeferredRegister(String modid, ResourceKey<? extends Registry<PRIMARY>> primaryRegistryName, net.neoforged.neoforge.registries.DeferredRegister<SECONDARY> secondaryRegistry) {
        this(BDeferredRegister.create(primaryRegistryName, modid), secondaryRegistry);
    }
